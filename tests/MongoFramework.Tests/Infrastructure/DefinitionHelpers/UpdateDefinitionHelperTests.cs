...
namespace MongoFramework.Tests.Infrastructure.DefinitionHelpers
{
	...
	public class UpdateDefinitionHelperTests : TestBase
	{
		...
		private BsonDocument RenderDefinition<TEntity>(UpdateDefinition<TEntity> definition)
		{
			...
			var renderArgs = new RenderArgs<TEntity>(documentSerializer, serializerRegistry, new PathRenderArgs(null, false), false, false, false, null);
			return definition.Render(renderArgs).AsBsonDocument;
		}
